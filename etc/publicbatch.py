...
#LOAD PUBLIC COURSES
###################################################
years=np.arange(2014,2014+1,1)
sems=[1]

courses=["0302419","0302417","0302636","0302382",
    #"0302100","0302164","0302251","0302252","0302261","0302262","0302265","0302275","0302301","0302308","0302310","0302313","0302314",
    #"0302318","0302330","0302331","0302332","0302335","0302340","0302341","0302360","0302361","0302375","0302408","0302411","0302412",
    #"0302420","0302422","0302435","0302463","0302470","0302475","0302480","0302490","0302491","0302495","0302500","0302501"
]
...
for year in years:
    ...
    for sem in sems:
        ...
        for codigo in courses:
            print "\t\tCourse: ",codigo
            codigoid="%s-v%d-%s"%(codigo,version,semid)
            system("cd ..;php export.php ver_curso=%s source=public mode=Vicedocencia > /dev/null"%(codigoid))
